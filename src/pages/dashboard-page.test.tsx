...
describe("Dashboard page", () => {
  test("renders a hybrid dashboard with quick actions and performance analysis", async () => {
    ...
    expect(screen.getAllByText("Planet Drill UTBK")[0]).toBeInTheDocument();
    expect(
    ...
    expect(
      screen.queryByText(/lulus profesi peserta UTBK dengan analisis pintar/i, { selector: 'h1, h2, h3, h4, h5, h6, [data-slot="card-title"], [data-slot="alert-title"]' }),
    ).not.toBeInTheDocument();
  }, 15000);
