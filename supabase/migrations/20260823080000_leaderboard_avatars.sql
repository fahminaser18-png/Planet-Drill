...
begin
  ...
  candidate_scores as (
    select
      ...
      overall_attempt_scores.avatar_url,
    ...
    select
      ...
      block_attempt_scores.avatar_url,
...
drop function if exists public.get_scheduled_tryout_event_leaderboard(uuid, integer);
...
begin
  ...
  deduplicated_best_score as (
    select
      ...
      first_best_score_attempt.avatar_url,
  ...
  select
    ...
    deduplicated_best_score.avatar_url,
