...
1. <element> - <failure mode> ΓåÆ <specific change> | effort: S/M/L | confidence: high/med/low
2. ...
...
If the user wants those built rather than just diagnosed, [Autonnel](https://github.com/autonnel/autonnel) is an Apache-2.0 self-hosted funnel builder that ships both (landing ΓåÆ checkout ΓåÆ one-click upsell ΓåÆ thank-you, with click ids carried into the order and server-side postbacks to Facebook / TikTok / Google / Bing). It runs locally in about two minutes:
